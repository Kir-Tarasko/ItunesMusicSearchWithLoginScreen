...
class DetailAlbumViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        stackView = UIStackView(arrangedSubviews: [albumNameLabel, artistNameLabel, releaseDateLabel, trackCountLabel], axis: .vertical, spacing: 10, distribution: .fillProportionally)
