...
class UserInfoViewController: UIViewController {
    ...
    private let phooneLabel: UILabel = {
        let label = UILabel()
        label.text = "Phone"
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    private func setupViews() {
        ...
        stackView = UIStackView(arrangedSubviews: [firstNameLabel, secondNameLabel, ageLabel, phooneLabel, emailLabel, passwordLabel], axis: .vertical, spacing: 10, distribution: .fillProportionally)
    ...
    private func setModel() {
        ...
        phooneLabel.text = activeUser.phone
